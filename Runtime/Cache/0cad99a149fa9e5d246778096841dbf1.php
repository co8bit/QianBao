          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <li><a href="__URL__/main" class="btn dropdown-toggle  btn-small btn btn-inverse">首页 </a></li>
               ...
               <li><a href="__URL__/sale" class="btn dropdown-toggle="dropdown" btn-small btn btn-inverse">销售单 </a></li>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="well sidebar-nav"><!-- 框架从这里开始 ////////////////////////////////////////////////////////// -->
  			...
  			<fieldset>
      <div id="legend" class="">
        <legend class=""><h1>销售单</h1></legend>
      </div>
	  <!-- Text input-->
          <label class="control-label" for="input01">客户名称</label>
          <div class="control-group info">
            <input placeholder="客户名称" name="company" class="input-xlarge" type="text">
          </div>
     <P>
