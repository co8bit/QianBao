      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <li><a href="__URL__/main" class="btn dropdown-toggle data-toggle btn-small btn btn-inverse">首页 </a></li>
               ...
               <li><a href="__URL__/about" class=" btn dropdown-toggle="dropdown" btn-small btn btn-inverse">关于 </a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            ...
            <strong><em><p>                 ————财务管理系统</p></em></strong>
            <p>本系统由co8bit制作。邮箱：me@co8bit.com  网址：www.co8bit.com</p>
          </div>
        </div><!--/span-->
      </div><!--/row-->
