          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <li><a href="__URL__/main" class="btn dropdown-toggle  btn-small btn btn-inverse">首页 </a></li>
               ...
               <li><a href="__URL__/accountdue" class="btn dropdown-toggle="dropdown" btn-small btn btn-inverse">应收款 </a></li>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="well sidebar-nav"><!-- 框架从这里开始 ////////////////////////////////////////////////////////// -->
           	<form class="form-signin" id="sale" name="sale" method="post" action="__URL__/accountdue_in">
           	
           	
           	
  			<fieldset>
      <div id="legend" class="">
        <legend class=""><h1>添加应收款</h1></legend>
      </div>
	  <!-- Text input-->
	  	<label class="control-label">债务方名称</label>
         <div align="center"><input placeholder="债务方名称" class="input-large" type="text" name="company_name"></div>
